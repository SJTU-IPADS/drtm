...
#machine_mapping  = {0:"cube0",1:"cube0"}
#machine_mapping = {0:"cube0",1:"cube0",2:"cube1",3:"cube1"}
#machine_mapping = {0:"cube0"}
#machine_mapping = {0:"cube0",1:"cube0",2:"cube1",3:"cube1",4:"cube2",5:"cube2"}
#machine_mapping = {0:"cube0",1:"cube0",2:"cube1",3:"cube1",4:"cube2",5:"cube2",6:"cube3",7:"cube3",8:"cube4",9:"cube4",10:"cube5",11:"cube5"}

#machine_mapping = {0:"cube0",1:"cube0",2:"cube1",3:"cube1",4:"cube2",5:"cube2",6:"cube3",7:"cube3",8:"cube4",9:"cube4"}
machine_mapping = {
    0:"10.0.0.100",
    1:"10.0.0.101",
    2:"10.0.0.102",
...
start_id = 0
target_dir = "projects/baseline/"
timeout    = 20 ##20 seconds
#num_threads = 8
num_threads = 10
scale_factor = num_threads
opt_per_worker = 100000
distributed_rate = 20
ratio = 1
...
def start_server(id):
    ...
    base_cmd = """ cd ~/%s; ./dbtest --bench tpcc --db-type ndb-proto2 --num-threads %d --scale-factor %d --txn-flags 1 --ops-per-worker %d --bench-opts "--w 45,43,4,4,4 -r %d" --verbose --retry-aborted-transactions --total-partition %d --current-partition %d --config   %s 1>/dev/null 2>&1 &""" % (target_dir,num_threads,1,opt_per_worker,ratio,len(machine_mapping),i,f)
...
if copy_mode:
    ...
    for  i in machine_mapping.keys():
        ...
        if sent_map.has_key(machine_mapping[i]):
            ...
            subprocess.call(["ssh",machine_mapping[i],"mkdir -p /home/wxd/%s" % target_dir])
